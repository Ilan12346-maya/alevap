package com.alevap.utils;

import static com.alevap.shared.termux.extrakeys.ExtraKeysConstants.PRIMARY_KEY_CODES_FOR_STRINGS;
import static com.alevap.MainActivity.toggleKeyboardVisibility;
...
import com.alevap.shared.termux.extrakeys.*;
import com.alevap.LoriePreferences;
import com.alevap.MainActivity;
...
public class TermuxX11ExtraKeys implements ExtraKeysView.IExtraKeysView {
    ...
    static final String ACTION_START_PREFERENCES_ACTIVITY = "com.alevap.start_preferences_activity";
